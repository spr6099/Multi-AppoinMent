...
const Profile = () => {
    ...
    const updateProfile = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(backendUrl + '/api/provider/update-profile', updateData, { headers: { dToken } })
    ...
    return profileData && (
        <div className='bg-slate-500'>
            <div className='flex flex-col gap-4 m-5 bg-'>
                <div>
                    <img className='bg-primary/80 w-full sm:max-w-64 rounded-lg h-[200px] w-[200px]' src={profileData.image} alt="" />
                </div>
